...
class MyApp(QWidget):
    ...
    def testOpen(self):
        ...
        model_log_btn = QPushButton()
        model_log_btn.setText('원본')
        model_log_btn.clicked.connect(self.open_log)
        btn2 = QPushButton()
        btn2.setText('결과')
        resultBox3.addWidget(model_log_btn)
    ...
    def chkItemClicked2(self):
        ...
        self.pixmap = QPixmap(self.test_model_path +
